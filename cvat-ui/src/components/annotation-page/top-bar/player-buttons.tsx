...
const componentShortcuts = {
    ...
    SEARCH_FORWARD: {
        name: '向前查找',
        description: '查找下一个符合筛选条件的帧',
        sequences: ['right'],
        scope: ShortcutScope.ANNOTATION_PAGE,
    },
    SEARCH_BACKWARD: {
        name: '向后查找',
        description: '查找上一个符合筛选条件的帧',
        sequences: ['left'],
        scope: ShortcutScope.ANNOTATION_PAGE,
    },
    CHAPTER_BACKWARD: {
...
function PlayerButtons(props: Props): JSX.Element {
    ...
    const prevFilteredText = '按筛选条件后退';
    const prevEmptyText = '跳至上一空帧';
    const prevChapterText = '跳至上一章节';
    const nextRegularText = '前进';
    const nextFilteredText = '按筛选条件前进';
    const nextEmptyText = '跳至下一空帧';
    const nextChapterText = '跳至下一章节';
    ...
    return (
        <Col className='cvat-player-buttons'>
            ...
            <CVATTooltip title={`单步后退 ${backwardShortcut}`}>
                <Icon
                    style={navIconStyle}
            ...
            <CVATTooltip title={`单步前进 ${forwardShortcut}`}>
                <Icon
                    style={navIconStyle}
