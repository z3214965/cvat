...
function LabelsMapperComponent(props: Props): JSX.Element {
    ...
    return (
        <ObjectMatcher
            ...
            deleteMappingLabel='移除映射标签'
            infoMappingLabel='指定标签之间的映射'
                    ...
                    extras.push(
                        <React.Fragment key='attributes'>
                            <ObjectMatcher
                                ...
                                deleteMappingLabel='移除映射属性'
                                infoMappingLabel='指定标签属性之间的映射'
