    ...
    private showInitialMessage(): void {
        this.onMessage(
            [
                ...
                {
                    type: 'list',
                    content: ['切割线不能自相交', '切割线与轮廓的交点不能超过两个'],
                    ...
                    [
                        {
                            type: 'text',
                            icon: 'info',
                            content: '如有需要，在图形轮廓内设置更多点。在另一点与轮廓相交以执行切割',
                        },
                        {
                            type: 'list',
                            content: ['按住 <Shift> 启用滑动模式', '点击 <右键> 取消上一个点'],
